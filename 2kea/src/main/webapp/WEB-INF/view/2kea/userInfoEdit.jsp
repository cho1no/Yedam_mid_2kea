						...
						<form class="row contact_form" action="signInControl.do"
							...
							<div class="col-md-12 form-group">
								...
								<input type="text" class="form-control" id="mName" name="mName"
									value="" placeholder="User Name"> <span class="error"
									id="username_error"></span>
							</div>
							<div class="col-md-12 form-group">
								<p>ID</p>
								<input type="text" class="form-control" id="id" name="id"
									value="" placeholder="Id"> <span class="error"
									id="id_error"></span>
							</div>
							<div class="col-md-12 form-group">
								<p>PASSWORD</p>
							...
							<div class="col-md-12 form-group">
								...
								<input type="email" class="form-control" id="email" name="email"
									value="" placeholder="Email"> <span class="error"
									id="email_error"></span>
							</div>
							<div class="col-md-12 form-group">
								<p>PHONE</p>
								<input type="tel" class="form-control" id="phone" name="phone"
									value="" placeholder="Phone"> <span class="error"
									id="tel_error"></span>
							</div>
							<input type="checkBox" class="form-control" id="phone"
								name="phone" value="" placeholder="Phone">
							<div class="col-md-12 form-group">
